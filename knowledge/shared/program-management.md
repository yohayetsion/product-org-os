...
**Source licence**: SAFe and PMI materials are per-source-terms; Anthropic knowledge-work-plugins is cited from https://github.com/anthropics/knowledge-work-plugins. No source text is reproduced.
...
## AI in Program/Project Management — The PMI AI Standard

### Attribution update (added 2026-06-25)
  **Sources consulted**: PMI, *The Standard for Artificial Intelligence in Portfolio, Program, and Project Management* (2026, ANSI-approved) — pmi.org/standards/artificial-intelligence; PMI press release, 2026 ("PMI Publishes World's First Global Standard for AI in Project Work").
  **Source licence**: per PMI terms — cited, not reproduced. Do not paste standard text into deliverables; reference and frame only.
  **V2V refinements**: pointer/framing section only; layered the V2V draft-not-decision posture (human decision rights + benefits ownership retained) onto the standard's responsible-AI framing.


In 2026, PMI published **The Standard for Artificial Intelligence in Portfolio, Program, and Project Management** — the first global, ANSI-approved standard for applying AI to professional project work. It exists because AI assistants, predictive-risk tooling, and agentic project aids are being deployed into program governance faster than the discipline has codified how to govern *them*. The standard's job is to move teams from AI experimentation to structured, responsible practice across three surfaces this pack already governs: **program governance** (where AI augments steering-committee inputs and status synthesis), **predictive risk** (where AI-driven analytics enable earlier risk detection in the program risk register), and **benefits tracking** (where AI assists benefits-realization measurement). Use it as the reference frame whenever AI tooling enters a program — it complements, and does not replace, PgMP governance or the lifecycle and dependency disciplines above.

**V2V caveat — pointer/framing only.** This section is a citation, not an adoption of autonomous AI into program decisions. Under the Operations Team posture, **humans retain decision rights and benefits ownership**; AI output is **draft, not decision**. AI may surface a predicted dependency slip, a risk-score delta, or a benefits-variance flag — a named human decider (per the Decision Rights Matrix above) still owns the call, and the steering committee still owns benefits acceptance. Treat AI-generated program signals exactly as the standard intends: structured input to human judgment, with accountability retained by the role, never transferred to the tool. (Project-level AI guidance is covered transitively by the same PMI lineage; see `project-management.md` — no separate AI section there.)

---

*Last Updated: 2026-06-25*
*References: PMI Standard for Program Management 4th Edition (PMI, 2017), SAFe 6.0 (Scaled Agile, 2023), Managing Successful Programmes (MSP, AXELOS), LeSS Framework (Larman & Vodde), PMI Standard for Artificial Intelligence in Portfolio, Program, and Project Management (PMI, 2026, ANSI-approved)*
