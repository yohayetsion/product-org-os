...
- **Interaction Designer** — runs it when evaluating external design systems for potential adoption
...
- `knowledge/shared/design-systems.md` — the foundation + AI-readiness layer pack that cites this rubric as its scoring framework.
