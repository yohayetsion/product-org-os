...
**Sources consulted**:
- [aaron-he-zhu/seo-geo-claude-skills](https://github.com/aaron-he-zhu/seo-geo-claude-skills) — GEO methodology and AI search optimization.
- Google AI Overviews / AI Mode May 2026 public updates — contextual source material.

**Source licence**: Apache-2.0 for `seo-geo-claude-skills`; other sources are cited, not reproduced.
**Our determination**: describes-public-method.

The dedicated `llm-seo.md` pack contains the detailed GEO tactics; this section is a cross-referenced summary.
...
**Example:**
```
Title: Insider Risk Management: AI-Powered Threat Detection | ExampleCo
Meta: Detect insider threats before they become breaches. ExampleCo's AI understands intent, not just actions. See how it works.
```
...
**Sources consulted**: aaron-he-zhu/seo-geo-claude-skills and the Ordemio LLM SEO Playbook. **Our determination**: describes-public-method.
...
| **Brand knowledge query** | "Tell me about ExampleCo Security" | Entity knowledge state |
...
Google shipped its biggest AI Overviews / AI Mode change since launch in May 2026 (two waves). Full GEO tactics live in the dedicated `llm-seo.md` pack; the short version for traditional-SEO practitioners:

- **2026-05-06 (Wave 1)** — five structural AI Overviews / AI Mode changes: (1) inline source links placed next to the generated text they support; (2) desktop hover-previews showing site name + page title; (3) highlighting of links the user already subscribes to (early tests: higher CTR); (4) "Expert advice / community perspectives" blocks pulling Reddit/forum/social quotes; (5) "Explore new angles" follow-up suggestions.
- **2026-05-19 (Google I/O 2026, Wave 2)** — Gemini 3.5 Flash became the default model in AI Mode globally (a datable algorithm-layer change: re-baseline AI Mode citation tracking from this date); AI Mode passed 1B monthly users; follow-ups can be asked directly from AI Overviews; redesigned multimodal Search box.

**SEO-practitioner takeaways**: page titles + clear site-name (entity registration) now drive citation hover-CTR; tight one-claim DAFs map to the new inline-citation surface; topic-cluster breadth feeds "Explore new angles" follow-ups; community/forum presence is now a *visible* surface, not just a training signal. See `llm-seo.md` for the full delta and tactical detail.
