...
**Sources consulted**:
- Anthropic knowledge-work-plugins (github.com/anthropics/knowledge-work-plugins) — legal/triage-nda
...
**Source licence**: per-source-terms for Anthropic knowledge-work-plugins, WorldCC and the named benchmark sources; methods are cited, not reproduced.
