...
<!-- Attribution:
  ...
  2026-06-06 delta sources (EU Pay Transparency Directive 2023/970 status):
  - Ogletree Deakins, "European Commission Confirms the EU Pay Transparency Directive Implementation Deadline Remains 7 June 2026"
    (ogletree.com/insights-resources/blog-posts/european-commission-confirms-the-eu-pay-transparency-directive-implementation-deadline-remains-7-june-2026/)
  - L&E Global, "European Union: Pay Transparency Directive — Europe Nears the Deadline but Most Member States Are Not Ready" (2026-05-27)
    (leglobal.law/2026/05/27/european-union-pay-transparency-directive-europe-nears-the-deadline-but-most-member-states-are-not-ready/)
  The underlying directive (Directive (EU) 2023/970) is a public EU legal instrument; the law-firm alerts are cited for navigation only.
-->

## 2026-06 Delta Update (as of 2026-06-06)

Reference content for drafting and triage, not legal advice. Verify against primary sources and local counsel before relying.

### EU Pay Transparency Directive (2023/970) — transposition deadline holds, but compliance is jurisdiction-by-jurisdiction

- The EU Pay Transparency Directive (Directive (EU) 2023/970) carries a **transposition deadline of 2026-06-07, which HOLDS** — the European Commission confirmed there is no extension.
- BUT as of late May 2026, **most member states are NOT yet transposed**: only ~2 (Italy, Slovakia) had comprehensive implementing legislation; ~10 had draft bills in progress; ~11 had nothing public. The Netherlands and Denmark are publicly targeting roughly 2027-01-01; Sweden has paused its process. Many member states are therefore now technically in breach of the directive and facing infringement risk.
- **Nuance for downstream use**: the deadline is fixed, but operative compliance is **state-by-state, not "EU-wide as of June 7."** When advising on EU pay-equity / pay-transparency obligations, treat them as live in transposed states (Italy, Slovakia) and as imminent-but-not-yet-locally-enacted elsewhere — verify the specific member state. The directive's core obligations (pre-employment pay-range disclosure, ban on salary-history questions, gender pay-gap reporting, right to information on pay levels) become enforceable in each state only once that state transposes.
- This pairs with the US salary-history-ban and pay-range-disclosure landscape already noted in the Interview Question Legality Matrix (CA, NY, MA, IL, CO) and is cross-referenced from `hr-ai-governance.md` §0.3 (which tracks the same directive for AI-driven comp tooling).
- Sources: Ogletree Deakins (European Commission confirmation that the deadline remains 2026-06-07); L&E Global (member-state transposition status as of 2026-05-27) — full URLs in the attribution block.
...
| **Pay transparency (EU)** | EU Pay Transparency Directive (2023/970): transposition deadline 2026-06-07 HOLDS, but as of late May 2026 most member states are NOT yet transposed (only ~2 comprehensive — Italy, Slovakia). Obligations (pay-range disclosure, salary-history ban, gender pay-gap reporting) become enforceable per member state only on local transposition. See 2026-06 Delta Update above. |
