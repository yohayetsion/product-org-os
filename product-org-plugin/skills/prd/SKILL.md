---
name: prd
description: 'Create or update a full Product Requirements Document with problem, solution, and acceptance criteria. Activate when: "write a PRD", "product requirements", "document the feature", formal
  requirements, product spec Do NOT activate for: lightweight PRD outline (/prd-outline), implementation-ready feature spec (/feature-spec), individual user stories (/user-story)'
