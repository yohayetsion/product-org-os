...
The complete measured list is in [COMPONENT-MANIFEST.md](./COMPONENT-MANIFEST.md). Direct command availability varies by coding-agent host; the files remain available as operating instructions.
...
See [What's new in Product Org OS 6](./whats-new-v6.html) for the full release story and [CHANGELOG.md](./CHANGELOG.md) for patch-level details.
...
- [Component manifest](./COMPONENT-MANIFEST.md): measured package contents
