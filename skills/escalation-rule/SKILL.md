...
metadata:
  ...
  vision_to_value_standard:
    aligned: true
    section: "Section 3.2 (escalation_rule field)"
    integrates_with: "Layer 3 Mode-Confirmation Audit primitive (../../standard/v5.0/mode-drift/layer-3-mode-confirmation.md)"
    reporter_api_endpoint: "POST /v2v/conformance/charter-escalation"
    escalation_types_emitted:
