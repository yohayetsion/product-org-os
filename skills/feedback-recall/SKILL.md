...
- **Product**: `/feedback-recall onboarding product:«Security Vendor»` → filtered to «Security Vendor» product
...
/feedback-recall pricing product:«Security Vendor»
→ Pricing feedback for «Security Vendor» product only

/feedback-recall product:«DTC Brand»
→ All feedback for «DTC Brand» product
```
