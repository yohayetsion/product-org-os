...
1. **Run `agent-output-handler.py`** (a local/optional presentation tool; not bundled with this repo) — this is the canonical generator:
   ```bash
...
- **Brand-adaptive** — auto-detects brand from title («Security Vendor», «AI Platform», «DTC Brand», «Design Agency») and applies correct colors, favicon, and logo
