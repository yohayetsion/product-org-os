...
metadata:
  ...
  vision_to_value_standard:
    aligned: true
    section: "Section 6 (Level 2 + Level 3 scale signals)"
    emits_signals:
    - schedule_of_records_queryable
    - conformance_level_reporter_output_recent
    note: "Level 2 + Level 3 signal stub in v5.0; full alignment in v5.1 (NOT load-bearing for Conformance Level 3 claim)"
---
