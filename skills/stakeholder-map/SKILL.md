...
description: 'Map stakeholder power, interest, and influence for a product initiative or decision. Activate when: "stakeholder map", "stakeholder analysis", "power interest matrix", "who to involve", "stakeholder
  engagement", "influence grid", "RACI" Do NOT activate for: ownership mapping for accountability (/ownership-map), collaboration quality checks (/collaboration-check)'
