...
description: 'Context-driven email subject line generator optimized for cold outreach and product communication. Activate when: "subject line", "email subject", "cold email subject", "subject line ideas",
  "email open rate", "subject line optimization" Do NOT activate for: campaign briefs (/campaign-brief)'
...
9. Offer to integrate with `/campaign-brief` if part of a larger flow
...
- **Outputs to**: `/campaign-brief` (subject line strategy informs campaign planning), `/sales-enablement` (outreach subject lines for sales team)
- **Related**: `/campaign-brief` (campaign-level planning)
