...
```
/risk-analysis «Bank» Deal
/risk-analysis «AI Platform» GTM launch
...
```
/risk-analysis update examples/risk-analysis-«bank»-deal-2026-04-11.md
```
...
```
/risk-analysis «Bank» Deal --mode adversarial --tiebreaker "«Reviewer»"
```
...
|---|---|---|
| Initiative or decision name | Yes | "«Security Vendor» «Bank» Deal" |
| Jurisdiction (or authorization to assume + flag) | Yes | "the customer's home jurisdiction + U.S. Delaware" |
| Counterparty / stakeholders | Yes | "«Bank» (customer jurisdiction), «Security Vendor» (Delaware parent + local sub)" |
...
>
> **Jurisdiction Assumed:** {e.g., "the customer's home jurisdiction + U.S. Delaware"}. If your
...
```
User: /risk-analysis «Bank» Deal

/risk-analysis v1.0.0 — reading:
  - examples/«bank»-proposal-v3.md
  - examples/«bank»-master-plan.md

Collecting inputs:
  - Initiative: «Security Vendor» «Bank» Deal
  - Jurisdiction: Assumed the customer's home jurisdiction (governing law) + Delaware («Security Vendor» parent entity). Flagged as assumption — confirm in Order Form governing-law clause.
  - Counterparty: «Bank», a top-tier bank in a strict-data-residency jurisdiction, regulated under a national banking cyber-defense directive
  - Stage: Pre-signature, proposal v3 drafted, awaiting technical deep-dive
  - Known constraints: SOC 2 not yet certified, bridge letter required; 4-person startup delivery capacity; «Security Vendor» local entity not yet formed

Producing output at:
  examples/risk-analysis-«bank»-deal-2026-04-11.md
