...
/interaction-recall pricing product:«Security Vendor»         → Product-filtered
...
| `product:` | Product name | `product:«Security Vendor»` |
| `type:` | Interaction type | `type:agent`, `type:gateway`, `type:skill` |

Multiple filters can be combined: `/interaction-recall pricing agent:pm product:«Security Vendor»`
...
### IX-2026-00042 | {emoji} product-manager | 2026-01-27 14:23
**Topics**: prd, authentication, requirements-gaps
**Product**: «Security Vendor»
...
```
User: /interaction-recall enterprise product:«Security Vendor» type:gateway

Agent: Returns gateway sessions about enterprise topics for «Security Vendor»
