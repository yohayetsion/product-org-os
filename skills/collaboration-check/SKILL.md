...
metadata:
  ...
  vision_to_value_standard:
    aligned: true
    section: "Section 3.2 (peer_reviewer_pool validation) + Section 6 (Level 2 collaboration signals)"
    emits_signals:
    - re_decision_triggers_firing_on_schedule
    validation_rule: "peer_reviewer_pool minimum 3 named individuals per Layer 3 designation rule; pool < 3 fails commitment-check"
    note: "Level 2 signal stub in v5.0; full alignment in v5.1 (NOT load-bearing for Conformance Level 3 claim)"
---
