...
metadata:
  ...
  vision_to_value_standard:
    aligned: true
    section: "Section 6 (Level 1 + Level 2 phase-transition signals)"
    emits_signals:
    - charter_state_is_fields_completed
    - mode_declaration_populated
    note: "Level 1 + Level 2 signal stub in v5.0; full alignment in v5.1 (NOT load-bearing for Conformance Level 3 claim)"
---
## Gotchas
