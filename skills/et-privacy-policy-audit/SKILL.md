...
```
/privacy-policy-audit «ai-platform».example/privacy
/privacy-policy-audit "«Security Vendor» public privacy policy draft"
...
```
/privacy-policy-audit update examples/privacy-policy-audit-2026-04-11.md
```
...
```
/privacy-policy-audit «ai-platform».example/privacy --mode adversarial --tiebreaker "«Reviewer»"
```
...
|---|---|---|
| Privacy policy document (path, URL, or pasted text) | Yes | `your-project/src/app/(legal)/privacy/page.tsx` |
...
```
User: /privacy-policy-audit your-project/src/app/(legal)/privacy/page.tsx

/privacy-policy-audit v1.0.0 — reading:
  - your-project/src/app/(legal)/privacy/page.tsx (Next.js JSX source)
  - Last updated: March 3, 2026
  - 11 sections, approx 1,200 words rendered text

Collecting inputs:
  - Policy: «AI Platform» Privacy Policy (v2026-03-03)
  ...
  - Processing context: B2C AI workforce platform, global user base, BYOT AI model
    ...
    the customer's jurisdiction + US, controller is «Holding Co».

Producing output at:
  examples/privacy-policy-audit-2026-04-11.md
