...
metadata:
  ...
  - pack: value-score-design.md
    trigger_keywords: value-score design business case framing
...
| `competitive-intelligence` | Market sizing data |
