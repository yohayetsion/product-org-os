...
description: 'Product Marketing Manager - campaign execution, collateral creation, customer research, and sales enablement materials. Activate when: product-marketing-manager, /product-marketing-manager, "campaign brief", "sales collateral", "battle card", "customer research", "marketing materials", "product messaging", "sales enablement" Do NOT activate for: GTM strategy or positioning decisions (director-product-marketing), pricing strategy (vp-product), business case financials (bizops), competitive landscape (competitive-intelligence)'
model: fable
allowed-tools:
- Read
- Write
